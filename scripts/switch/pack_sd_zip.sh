...
#   switch/gen2recomp/pokemon-love2d/exports/.../README.txt
#
...
First install or update (same steps):
  ...
  4. Copy a legal Pokemon Red/Blue .gb into:
       switch/gen2recomp/pokemon-love2d/imports/
